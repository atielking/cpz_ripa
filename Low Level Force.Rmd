...
RIPA_join_cds <- left_join(RIPA_annotated_codes, CDS_Codes, by=c("STOP_CODE"="CDS.Code")) %>% mutate(IS_LOW_LEVEL = ifelse(str_detect(Offense.Description, "VANDALISM") | str_detect(Offense.Description, "LOITER") | str_detect(Offense.Description, "CURFEW") | str_detect(Offense.Description, "DISORD") | str_detect(Offense.Description, "MENTAL") | str_detect(Offense.Description, "PARAPH") | str_detect(Offense.Description, "TRESPASS") | str_detect(Offense.Description, "LOCAL ORDINANCE") | str_detect(Offense.Description, "PROSTITUT")))
