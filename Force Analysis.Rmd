...
RIPA_force <- RIPA_annotated %>% 
  ...
  select(use_of_force_count, ADS_FIREARM_POINT, ADS_FIREARM_DISCHARGE, ADS_BATON, ADS_CHEM_SPRAY, 
         ADS_IMPACT_DISCHARGE, ADS_CANINE_BITE, ADS_ELECT_DEVICE, ADS_OTHER_CONTACT) 
