...
RIPA_r_force <- RIPA.Stop.Data.2018 %>% 
  ...
  select(AGENCY_NAME, RACE, use_of_force)
...
write_csv(simplified_ripa_hispanic, path="../force_sig/ripa_sf_hispanic_force.csv")
write_csv(simplified_ripa_black, path="../force_sig/ripa_sf_black_force.csv")
```
